...
const instructions = [
  {
    ...
    content: (
      <>
        <p>
          You will receive a “Download Your Badge” email one week before the
          event, sent to your registered email address.
        </p>
  ...
  },
  {
    ...
    content: (
      <p>
        Print the badge clearly on A4 paper, ensuring the QR code is fully
        visible. This printed badge will serve as your entry pass.
      </p>
    ),
  },
  {
    ...
    content: <p>Carry your badge with you on the event days to gain access.</p>,
  },
];
    ...
    <div className="badge-instructions">
      ...
      <div className="row">
        {instructions.map((instruction) => (
          <div className="col-xl-4 col-lg-6 col-md-6" key={instruction.id}>
        ...
        <div className="col-lg-12">
          ...
          <div className="need-asistance">
            ...
            <p>
              If you haven’t received your badge email or need help,
              <br />
              please contact our team at{" "}
              <span>
                <a href="mailto:support@example.com">Example.com</a>
              </span>
            </p>
          </div>
        </div>
